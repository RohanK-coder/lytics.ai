...
export default function Signin() {
  ...
  const handleSubmit = async (e:any) => {
    ...
    try {
      ...
      if (response.data.token) {
        // Save the token in localStorage/sessionStorage if needed
  ...
  return (
    <div className="w-screen h-screen border-2 flex flex-row border-red-500 items-center justify-center gap-12">
